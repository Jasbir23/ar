...
THREEx.Planets.createSun = function() {
  ...
  var texture = THREE.ImageUtils.loadTexture(
    THREEx.Planets.baseURL + "images/sunmap.jpg"
  );
...
THREEx.Planets.createMercury = function() {
  ...
  var material = new THREE.MeshPhongMaterial({
    map: THREE.ImageUtils.loadTexture(
      THREEx.Planets.baseURL + "images/mercurymap.jpg"
    ),
    bumpMap: THREE.ImageUtils.loadTexture(
      THREEx.Planets.baseURL + "images/mercurybump.jpg"
    ),
    bumpScale: 0.005
  });
  var mesh = new THREE.Mesh(geometry, material);
...
THREEx.Planets.createVenus = function() {
  ...
  var material = new THREE.MeshPhongMaterial({
    map: THREE.ImageUtils.loadTexture(
      THREEx.Planets.baseURL + "images/venusmap.jpg"
    ),
    bumpMap: THREE.ImageUtils.loadTexture(
      THREEx.Planets.baseURL + "images/venusbump.jpg"
    ),
    bumpScale: 0.005
  });
  var mesh = new THREE.Mesh(geometry, material);
...
THREEx.Planets.createEarth = function() {
  ...
  var material = new THREE.MeshPhongMaterial({
    map: THREE.ImageUtils.loadTexture(
      THREEx.Planets.baseURL + "images/earthmap1k.jpg"
    ),
    bumpMap: THREE.ImageUtils.loadTexture(
      THREEx.Planets.baseURL + "images/earthbump1k.jpg"
    ),
    bumpScale: 0.05,
...
THREEx.Planets.createStarfield = function() {
  var texture = THREE.ImageUtils.loadTexture(
    THREEx.Planets.baseURL + "images/galaxy_starfield.png"
  );
